...
#  	puts "1 Estate customer created"
 ...
 Review.create!(full_name: "JoAnn N.", service_purchased: "Tax", body: "I launched a new business last year. Signing up for the Prime Corporate Services Business Credit Program is one of the best and wisest choices I have made! This program has been a success as it has (1) started me on my way to increased benefits for my company, (2) provided savings on my business tax return, and (3) enabled me to establish credibility and independence for my company.", rating: 5, status: 1)

  puts "1 Review Created"

 Review.create!(full_name: "Donna J.", service_purchased: "Tax", body: "Prime Corporate helped develop my business and are there to prepare my taxes and answer my financial questions. I would recommend Prime Corporate Services to anyone who needs assistance, no matter what their endeavor may be.", rating: 4, status: 1)

  puts "1 Review Created"

 Review.create!(full_name: "Brenda & Mike L.", service_purchased: "Corporate Credit", body: "With the help of this Business Credit Program & the superior guidance from Fred our coach, we were able to build up a business credit & financial stability in a very limited amount of time. We were uncertain how we were going to accomplish this, but with following the simple step by step approach, we now have the ability to obtain the financial security needed to grow our e-commerce business", rating: 5, status: 1)

  puts "1 Review Created"

 Review.create!(full_name: "Natalie E.", service_purchased: "Corporate Credit", body: "This program has helped me begin the process of getting a separate credit score from my personal credit score which I had no idea how to do. Thank you!", rating: 5, status: 1)

  puts "1 Review Created"

 Review.create!(full_name: "David R.", service_purchased: "Corporate Credit", body: "Prime Corporate Services gave us easy-to-follow instructions and we were able to accomplish all items necessary to establish our business credit with companies that report to Dun & Bradstreet, which is an important part of a successful business plan. We would recommend Prime Corporate Services to anyone who is interested in developing a respected business credit rating.", rating: 5, status: 1)
